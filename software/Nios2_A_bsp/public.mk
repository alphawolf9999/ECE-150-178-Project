...
SOPCINFO_FILE := C:/Users/jguti/OneDrive/Desktop/ECE_150_Project/ECE_150_Project/unsaved.sopcinfo
...
# CPU Name 
# setting CPU_NAME is Nios2_A_nios2_gen2_0
CPU_NAME = Nios2_A_nios2_gen2_0
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1636430330
SOPC_SYSID_FLAG += --timestamp=1636430330
ELF_PATCH_FLAG  += --timestamp 1636430330
...
# setting hal.stderr is Nios2_A_jtag_uart_0
ELF_PATCH_FLAG  += --stderr_dev Nios2_A_jtag_uart_0

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is Nios2_A_jtag_uart_0
ELF_PATCH_FLAG  += --stdin_dev Nios2_A_jtag_uart_0
...
# setting hal.stdout is Nios2_A_jtag_uart_0
ELF_PATCH_FLAG  += --stdout_dev Nios2_A_jtag_uart_0
