...
# Memory: Nios2_B_onchip_memory2_0
MEM_0 := unsaved_Nios2_B_onchip_memory2_0
$(MEM_0)_NAME := Nios2_B_onchip_memory2_0
...
$(MEM_0)_END := 0x00014faf
$(MEM_0)_SPAN := 0x00004fb0
$(MEM_0)_HIERARCHICAL_PATH := Nios2_B.onchip_memory2_0
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: Nios2_B_onchip_memory2_0
Nios2_B_onchip_memory2_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
