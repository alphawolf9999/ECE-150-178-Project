...
SOPCINFO_FILE := c:/Users/jguti/OneDrive/Desktop/Homework4/NEWTEST/unsaved.sopcinfo
...
# CPU Name 
# setting CPU_NAME is Nios2_B_nios2_gen2_0
CPU_NAME = Nios2_B_nios2_gen2_0
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1636086916
SOPC_SYSID_FLAG += --timestamp=1636086916
ELF_PATCH_FLAG  += --timestamp 1636086916
...
# setting hal.stderr is Nios2_B_jtag_uart_0
ELF_PATCH_FLAG  += --stderr_dev Nios2_B_jtag_uart_0

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is Nios2_B_jtag_uart_0
ELF_PATCH_FLAG  += --stdin_dev Nios2_B_jtag_uart_0
...
# setting hal.stdout is Nios2_B_jtag_uart_0
ELF_PATCH_FLAG  += --stdout_dev Nios2_B_jtag_uart_0
